...
export default function ActiveFromData({data}) {
  ...
  const history = data?.map((data, index) => (
    <>
      <div
        ...
        className="flex items-center border-b-2 px-3 py-2"
      >
        <button
          href
          className={`${
      ...
      >
        <div className="flex w-full justify-center">
          <p className="border-b-2 pb-2">Form Data:</p>
        </div>
            ...
            <>
              ...
              >
                {tabel.map((item, indx) => (
                  <div
                    key={indx}
                    className={` m-1 flex h-8 w-8 items-center justify-center rounded-full bg-red-400`}
                  >
                    {item}
                  </div>
                ))}

...
import extraImg from "/EXTRA-on.png";
...
export default function Form() {
  ...
  useEffect(() => {
    let totalPay = 99.96 * state.lottery + (state.type - 4) * 25;
  ...
  return (
    <div className="flex flex-col gap-3">
      <div className="flex gap-3 rounded-xl bg-blue-500 p-3">
        ...
        <div className="grid w-fit grid-cols-4 gap-2">
          ...
          <button
            ...
            onClick={() =>
              dispatch({ type: actions.UPDATE_LOTTERY, payload: 8 })
            }
          >
            8
          </button>
          ...
          <button
            ...
            onClick={() =>
              dispatch({ type: actions.UPDATE_LOTTERY, payload: 4 })
            }
          >
            4
          </button>
          ...
          <button
            ...
            onClick={() =>
              dispatch({ type: actions.UPDATE_LOTTERY, payload: 2 })
            }
          >
            2
          </button>
          ...
          <button
            ...
            onClick={() =>
              dispatch({ type: actions.UPDATE_LOTTERY, payload: 1 })
            }
          >
            1
          </button>
          ...
          <button
            ...
            onClick={() =>
              dispatch({ type: actions.UPDATE_LOTTERY, payload: 10 })
            }
          >
            Auto renews
          </button>
      ...
      <div className="flex items-center gap-3 rounded-xl bg-amber-400 p-3">
        ...
        <img src={extraImg} alt="" className="ml-auto" />
        <button
          className={`${
            state.extra ? "bg-orange-600" : "bg-white"
          } grid h-9 w-9 rounded border p-1`}
          onClick={() => dispatch({ type: actions.TOGGLE_EXTRA })}
          title="set extra"
        >
          {state.extra && (
            <svg
